...
/*
	StraightLineRPGGame.h

	This file contains setup data for making the StraightLineRPG game. Note that nearly
	all of this data would better serve us if loaded from files.
*/

// HERE IS THE StraightLineRPG GAME SETUP/INIT FILE. EVERYTHING WOULD START FROM HERE
static const wstring	W_LEVEL_1_DIR			= L"data/levels/OverworldChapter1/";
static const wstring	W_LEVEL_1_NAME			= L"testlevel.tmx";
static const wstring	W_LEVEL_1_PATH			= W_LEVEL_1_DIR + W_LEVEL_1_NAME;
static const wstring	W_LEVEL_2_DIR			= L"data/levels/OverworldChapter2/";
static const wstring	W_LEVEL_2_NAME			= L"testlevel.tmx";
static const wstring	W_LEVEL_2_PATH			= W_LEVEL_2_DIR + W_LEVEL_2_NAME;
static const wstring	W_INIT_FILE				= L"data/StraightLineRPGInit.txt";
static const wstring	W_GUI_INIT_FILE			= L"data/StraightLineRPGGUI.txt";
...
static const wstring	W_GAME_CONTROLS_COMMAND	= L"Game Controls";
...
static const wstring	W_ABOUT_PATH			= L"data/gui/overlays/about_screen_overlay.png";
static const wstring	W_GAME_CONTROLS_PATH		= L"data/gui/overlays/game_controls_overlay.png";
static const wstring	W_VICTORY_PATH			= L"data/gui/overlays/victory_overlay2.png";
static const wstring	W_DEATH_PATH			= L"data/gui/overlays/death_overlay.png";
static const wstring	W_ACTION_MENU_BG_PATH		= L"data/gui/overlays/action_menu_background_choices.png";
static const wstring	W_ACTION_MENU_HP_PATH		= L"data/gui/overlays/action_menu_background_stats.png";
...
static const wstring	W_EXIT_IMAGE_PATH		= L"data/gui/buttons/quit.png";
static const wstring	W_EXIT_IMAGE_MO_PATH	= L"data/gui/buttons/quit_mo.png";
...
static const wstring	W_GAME_CONTROLS_IMAGE_PATH		= L"data/gui/buttons/game_controls.png";
static const wstring	W_GAME_CONTROLS_IMAGE_MO_PATH	= L"data/gui/buttons/game_controls_mo.png";
...
static const float		PLAYER_INIT_X = 320.0f;
static const float		PLAYER_INIT_Y = 320.0f;
static const float		JUMP_SPEED = -24.0f;
static const float		PLAYER_SPEED = 36.0f *100;
...
// GUI STUFF FOR POSITIONING
static const float		MONSTER_SPRITE_X = 200.0f;
static const float		MONSTER_SPRITE_Y = 25.0f;