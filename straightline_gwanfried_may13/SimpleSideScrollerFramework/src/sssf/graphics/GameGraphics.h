...
protected:
	...
	// WE'LL STORE THE SCREEN DIMENSIONS HERE
	int screenWidth;
	int screenHeight;
	...
	bool battleTextShouldBeRendered;
...
public:	
	...
	// TOGGLE STAT TEXTS
	void toggleBattleTextShouldBeRendered()
	{ battleTextShouldBeRendered = !battleTextShouldBeRendered; }
