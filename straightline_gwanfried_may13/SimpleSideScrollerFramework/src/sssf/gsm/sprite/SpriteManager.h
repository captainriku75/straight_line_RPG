...
private:
	...
	//menu cursor pointer for battles
...
public:
	SpriteManager()		{playerPresent = true;}
	~SpriteManager()	{}

	// INLINED ACCESSOR METHODS
	int						getNumberOfSprites()	{ return bots.size();		}
	AnimatedSprite*			getPlayer()				{ return &player;			}
	MenuCursor*			getMenuCursor()			{ return &menuCursor;		}
	bool					isPlayerPresent()		{ return playerPresent;		}
	void					setPlayerPresent(bool newStatus) {playerPresent = newStatus;}
