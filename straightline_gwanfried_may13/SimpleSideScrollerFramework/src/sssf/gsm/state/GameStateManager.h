...
public:
	...
	bool battleTransitionFlag;
	bool overworldTransitionFlag;
	bool deathTransitionFlag;
	bool victoryTransitionFlag;

	bool destroyBodiesFlag;
	...
	b2World* getSuperWorld() {return &b2world;} 
	...
	int getNumMonstersKilled() {return numMonstersKilled;}
	void setNumMonstersKilled(int newCount) {numMonstersKilled = newCount;}
};